...
bool
interactivity_manager::suspend_interactive()
{
	return m_impl->suspend_interactive();
}
...
const string_t&
interactivity_manager::interactive_version() const
{
	return m_impl->interactive_version();
}
